...
async def get_readable_message(sid, is_user, page_no=1, status="All", page_step=1):
    ...
    for index, task in enumerate(
        ...
        msg += f"\n\n<blockquote><b>Task By {task.listener.message.from_user.mention(style='html')} </b> ( #ID{task.listener.message.from_user.id} )"
        ...
        # TODO: Add Bt Sel
        msg += f"\n<b>/{BotCommands.CancelTaskCommand[1]}_{task.gid()}</b></blockquote>\n\n"
